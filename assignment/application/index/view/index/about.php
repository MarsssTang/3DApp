...
<section class="hero-section"><a href="#about" class="banner-icon"><i class="flaticon-down-arrow"></i></a>
  <div class="container">
    <div class="hero-content">
      <h1 class="title" data-bg=""><span>About</span></h1>
    </div>
  </div>
</section>
      ...
      <div class="col-lg-10">
        <div class="post-item post-details">
          <div class="post-content">
            <h4 class="title">Some things to know about the Coca-Cola Family website </h4>
            <p>3D Apps is my final year module in undergraduate, it will show the three product 3d models of coca cola company based on what I have learned in the lab stage.</p>
          </div>
        </div>
