...
<section class="hero-section"><a href="#about" class="banner-icon"><i class="flaticon-down-arrow"></i></a>
  <div class="container">
    <div class="hero-content">
      <h1 class="title" data-bg=""><span>Original statement</span></h1>
    </div>
  </div>
</section>
      ...
      <div class="col-lg-10">
        <div class="post-item post-details">
          <div class="post-content">
            <h4 class="title">Coca-Cola Family website </h4>
            <p>These web pages are submitted as part requirement for the degree of computer science and artificial intelligence(BSc) at the University of Sussex.  They are the product of my own labour except where indicated in the web page content. These web pages or contents may be freely copied and distributed provided the source is acknowledged.</p>
          </div>
        </div>
